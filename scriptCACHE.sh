...
execute_simulation() {
    ...
    local OUTPUT_DIR="$BASE_DIR/Upgrades/CACHE/ResultsINT_${BENCH}.txt"
...
-redir:sim $OUTPUT_DIR $EXE $COMMAND"
    ...
    local OUTPUT_DIR="$BASE_DIR/Upgrades/CACHE/ResultsAMD_${BENCH}.txt"
