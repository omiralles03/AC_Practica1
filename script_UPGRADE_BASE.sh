...
# Script BASE per canviar els parametres de millora
# Canviar el nom de UPGRADE al nom de la millora 
# dins del directori de Upgrades (ja afegit el output path)
UPGRADE="UPGRADE"
