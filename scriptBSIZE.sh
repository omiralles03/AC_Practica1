...
INT_IL1_SIZE=32  # KB
INT_IL1_BSIZE=128 # Bytes

INT_DL1_SIZE=48  # KB
INT_DL1_BSIZE=128 # Bytes

INT_UL2_SIZE=1280 # KB
INT_UL2_BSIZE=128  # Bytes
...
AMD_IL1_SIZE=32  # KB
AMD_IL1_BSIZE=128 # Bytes

AMD_DL1_SIZE=32  # KB
AMD_DL1_BSIZE=128 # Bytes

AMD_UL2_SIZE=1024 # KB
AMD_UL2_BSIZE=128  # Bytes
...
execute_simulation() {
    ...
    local OUTPUT_DIR="$BASE_DIR/Upgrades/BSIZE/ResultsINT_${BENCH}.txt"
...
-redir:sim $OUTPUT_DIR $EXE $COMMAND"
    ...
    local OUTPUT_DIR="$BASE_DIR/Upgrades/BSIZE/ResultsAMD_${BENCH}.txt"
